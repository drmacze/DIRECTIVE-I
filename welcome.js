(() => {
  ...
  function animateCount(element, target, duration = 8500) {
    if (!element) return;
  ...
  function renderStats(stats, duration = 8500) {
  ...
  async function fetchNetworkStats() {
    try {
      ...
      renderStats(data.stats, 8500);
    } catch (_) {}
  }

  renderStats({ accountLogins: 10000, lifetimeUserPlays: 1 }, 9000);
